...
let first_hw_tests = Header ("------FIRST HW----", [
    ...
    Header ("----THIRD PART----", [
        ...
        T_case ("lambda of string",
            [String (string_of_lambda (lambda_of_string "\\x.\\y.x"));
            String (string_of_lambda (lambda_of_string "b \\x.\\y.a"));
            String (debug_string_of_lambda (lambda_of_string ("a b c d e f g")));
            String "b \\x.\\y.a";
            String (string_of_lambda(lambda_of_string "b \\x.\\y.a"));
            String (string_of_lambda(lambda_of_string (string_of_lambda (lambda_of_string "b \\x.\\y.a"))));
            String (string_of_lambda(lambda_of_string (string_of_lambda (lambda_of_string "(b (\\x.(\\y.a)))"))))])
    ])
]);;
